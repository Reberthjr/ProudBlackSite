...
namespace ProudBlack.Areas.Admin.Controllers
{
    ...
    public class AdminProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,EmPromocao,EmEstoque,CategoriaID")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,DescricaoCurta,DescricaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,EmPromocao,EmEstoque,CategoriaID")] Produto produto)
        {
